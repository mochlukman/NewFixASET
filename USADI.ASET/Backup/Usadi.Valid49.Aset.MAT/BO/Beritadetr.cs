...
namespace Usadi.Valid49.BO
{
  ...
  public class BeritadetrControl : BaseDataControlAsetMAT, IDataControlUIEntry, IHasJSScript, IExtDataControl
  {
    ...
    public new IProperties GetProperties()
    {
      ...
      cViewListProperties.LookupDC = " Usadi.Valid49.BO.DaskrLookupControl, Usadi.Valid49.Aset.DM";
    ...
    public override DataControlFieldCollection GetColumns()
    {
      ...
      columns.Add(Fields.Create(ConstantDict.GetColumnTitle("Nilaisisa=Nilai Sisa Rekening DPA"), typeof(decimal), 30, HorizontalAlign.Left));
      return columns;
    }
