...
namespace Usadi.Valid49.BO
{
  ...
  public class KibcControl : BaseDataControlAsetMAT, IDataControlUIEntry, IHasJSScript
  {
    ...
    public new void Insert()
    {
      ...
      string sql = @"
        ...
        @Nilinsert = N'{23}'
        ";
      sql = string.Format(sql, Unitkey, Asetkey, Tahun, Kdpemilik, Asalusul, Pengguna, Ket, Kdkon, Kdhak, Bertingkat, Beton, Luaslt
        , Alamat, Nodokgdg, Tgdokgdg.ToString("yyyy-MM-dd"), Luastnh, Nokdtanah, Kdsatuan, Noba, Tglperolehan.ToString("yyyy-MM-dd")
    ...
    public override HashTableofParameterRow GetEntries()
    {
      ...
      KibcControl cKibcCekdata = new KibcControl();
      cKibcCekdata.Unitkey = Unitkey;
      cKibcCekdata.Asetkey = Asetkey;
      cKibcCekdata.Keyinv = Keyinv;
      cKibcCekdata.Load("Cekjmldata");

      if (cKibcCekdata.Jmldata != 0)
      {
        Jml = 1;
        Nilinsert = "2";
      }
  ...
  #region KibcEkstra
  [Serializable]
  public class KibcEkstraControl : KibcControl, IDataControlUIEntry
  {
    public new IList View()
    {
