...
namespace Usadi.Valid49.BO
{
  ...
  public class KibfControl : BaseDataControlAsetMAT, IDataControlUIEntry, IHasJSScript
  {
    ...
    public override DataControlFieldCollection GetColumns()
    {
      ...
      columns.Add(Fields.Create(ConstantDict.GetColumnTitle("Idtermin=Termin"), typeof(int), 10, HorizontalAlign.Left));
      columns.Add(Fields.Create(ConstantDict.GetColumnTitle("Prosenfisik=Prosentase Fisik"), typeof(decimal), 20, HorizontalAlign.Left));
      columns.Add(Fields.Create(ConstantDict.GetColumnTitle("Prosenbiaya=Prosentase Biaya"), typeof(decimal), 20, HorizontalAlign.Left));
    ...
    public new void Insert()
    {
      ...
      sql = string.Format(sql, Unitkey, Asetkey, Tahun, Kdpemilik, Asalusul, Ket, Kdhak, Kdfisik, Bertingkat, Beton, Luaslt
        ...
        , Idtermin, Prosenfisik, Prosenbiaya, Noba, Tglperolehan.ToString("yyyy-MM-dd"), Kdtans, Nilai, Jml, Nilinsert);
    ...
    public override HashTableofParameterRow GetEntries()
    {
      ...
      KibfControl cKibfCekdata = new KibfControl();
      cKibfCekdata.Unitkey = Unitkey;
      cKibfCekdata.Asetkey = Asetkey;
      cKibfCekdata.Keyinv = Keyinv;
      cKibfCekdata.Load("Cekjmldata");

      if (cKibfCekdata.Jmldata != 0)
      {
        Jml = 1;
        Nilinsert = "2";
      }
      ...
      hpars.Add(new ParameterRowTextBox(this, ConstantDict.GetColumnTitle("Nodokkdp=Nomor Dok KDP"), true, 50).SetEnable(enable).SetGroup(GROUP_1));
      hpars.Add(new ParameterRowDate(this, ConstantDict.GetColumnTitle("Tgdokkdp=Tanggal Dok KDP"), true).SetEnable(enable).SetGroup(GROUP_1));
      ...
      hpars.Add(new ParameterRowNumeric(this, ConstantDict.GetColumnTitle("Idtermin=Termin"), true, 15).SetEnable(enable).SetEditable(false)
        .SetAllowEmpty(false).SetGroup(GROUP_3), 1);

      hpars.Add(new ParameterRowNumeric(this, ConstantDict.GetColumnTitle("Prosenfisik=Prosentase Fisik"), true, 50).SetEnable(enable).SetEditable(false)
        .SetAllowEmpty(false).SetGroup(GROUP_3));

      hpars.Add(new ParameterRowNumeric(this, ConstantDict.GetColumnTitle("Prosenbiaya=Prosentase Biaya"), true, 50).SetEnable(enable).SetEditable(false)
        .SetAllowEmpty(false).SetGroup(GROUP_3));
