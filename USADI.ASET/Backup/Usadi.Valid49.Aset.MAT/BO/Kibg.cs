  ...
  public class KibgControl : BaseDataControlAsetMAT, IDataControlUIEntry, IHasJSScript
  {
    ...
    public new void Insert()
    {
      ...
      string sql = @"
        ...
        @Nilinsert = N'{19}'
        ";
      sql = string.Format(sql, Unitkey, Asetkey, Tahun, Kdpemilik, Asalusul, Ket, Kdkon, Pengguna, Judul
        , Pencipta, Spesifikasi, Jenis, Ukuran, Kdsatuan, Noba, Tglperolehan.ToString("yyyy-MM-dd"), Kdtans, Nilai, Jml, Nilinsert);
    ...
    public override HashTableofParameterRow GetEntries()
    {
      ...
      KibgControl cKibgCekdata = new KibgControl();
      cKibgCekdata.Unitkey = Unitkey;
      cKibgCekdata.Asetkey = Asetkey;
      cKibgCekdata.Keyinv = Keyinv;
      cKibgCekdata.Load("Cekjmldata");

      if (cKibgCekdata.Jmldata != 0)
      {
        Jml = 1;
        Nilinsert = "2";
      }
