...
namespace Usadi.Valid49.BO
{
  ...
  public class PenyusutanControl : BaseDataControlAsetMAT, IDataControlUIEntry, IHasJSScript
  {
    ...
    public override DataControlFieldCollection GetColumns()
    {
      ...
      columns.Add(Fields.Create(ConstantDict.GetColumnTitle("Sisamasapakai=Sisa Masa Pakai"), typeof(decimal), 18, HorizontalAlign.Left));
    ...
    public new void Insert()
    {
      ...
      sql = string.Format(sql, Kdaset, Unitkey, Kdtahun, Kd_bulan);
  ...
  #region PenyusutanValid
  [Serializable]
  public class PenyusutanValidControl : PenyusutanControl, IDataControlUIEntry
  {
    public new IProperties GetProperties()
    {
      ViewListProperties cViewListProperties = (ViewListProperties)base.GetProperties();
    ...
    public override HashTableofParameterRow GetEntries()
    {
      ...
      PenyusutanValidControl cPenyusutanCekvalid = new PenyusutanValidControl();
