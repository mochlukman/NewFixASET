...
namespace Usadi.Valid49.BO
{
  ...
  public class PenyusutandetControl : BaseDataControlAsetMAT, IDataControlUIEntry, IHasJSScript
  {
    ...
    public new IProperties GetProperties()
    {
      ...
      cViewListProperties.PrimaryKeys = new String[] { "Bulan", "Tahunhitung", "Idbrg", "Unitkey", "Asetkey", "Kdtahun", "Kd_bulan" };
    ...
    public new void SetFilterKey(BaseBO bo)
    {
      ...
      else if (typeof(PenyusutanControl).IsInstanceOfType(bo))
      {
        ...
        Unitkey = ((PenyusutanControl)bo).Unitkey;
        Asetkey = ((PenyusutanControl)bo).Asetkey;
        Kdtahun = Int32.Parse(((PenyusutanControl)bo).Kdtahun);
        Kd_bulan = Int32.Parse(((PenyusutanControl)bo).Kd_bulan);
      }
    }
