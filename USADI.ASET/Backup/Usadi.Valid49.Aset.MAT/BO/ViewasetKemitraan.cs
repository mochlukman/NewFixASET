...
{
  #region Usadi.Valid49.BO.ViewasetKemitraanControl, Usadi.Valid49.Aset.MAT
  [Serializable]
  public class ViewasetKemitraanControl : BaseDataControlAsetMAT, IDataControlUIEntry, IHasJSScript
  {
    #region Properties
    ...
    public override DataControlFieldCollection GetColumns()
    {
      ...
      columns.Add(Fields.Create(ConstantDict.GetColumnTitle("Nopenilaian=No Penilaian"), typeof(string), 20, HorizontalAlign.Left));
    ...
    public new IList View()
    {
      ...
      string[] fields = new string[] { "Idbrg", "Asetkey", "Kdaset", "Nmaset", "Tahun", "Noreg", "Nilai", "Merktype", "Alamat"
        , "Ket", "Kdkon", "Nmkon", "Kdklas", "Nopenilaian" };
      List<IDataControl> list = BaseDataAdapter.GetListDC(this, sql, fields);
      List<ViewasetKemitraanControl> ListData = new List<ViewasetKemitraanControl>();

      foreach (ViewasetKemitraanControl dc in list)
      {
        ListData.Add(dc);
      }
      return ListData;
