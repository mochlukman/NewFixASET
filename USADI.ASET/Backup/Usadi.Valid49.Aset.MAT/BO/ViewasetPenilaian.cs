...
{
  #region Usadi.Valid49.BO.ViewasetPenilaianControl, Usadi.Valid49.Aset.MAT
  [Serializable]
  public class ViewasetPenilaianControl : BaseDataControlAsetMAT, IDataControlUIEntry, IHasJSScript
  {
    #region Properties
