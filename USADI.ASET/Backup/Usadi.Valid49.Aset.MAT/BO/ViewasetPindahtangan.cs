...
{
  #region Usadi.Valid49.BO.ViewasetPindahtanganControl, Usadi.Valid49.Aset.MAT
  [Serializable]
  public class ViewasetPindahtanganControl : BaseDataControlAsetMAT, IDataControlUIEntry, IHasJSScript
  {
    #region Properties
    ...
    public new IList View()
    {
      ...
      sql = string.Format(sql, Unitkey, Nopenilaian, Kdtans);
