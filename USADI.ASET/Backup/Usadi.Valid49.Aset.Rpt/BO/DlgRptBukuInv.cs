...
namespace Usadi.Valid49.BO
{
  ...
  public class DlgRptBukuInvControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "RptBukuInv.rpt";
      CS[ReportUtils.PDFNAME] = "RptBukuInv.pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.RptBukuInv.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "Buku Inventaris", RptClass = LinkPdf };
