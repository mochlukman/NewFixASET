...
namespace Usadi.Valid49.BO
{
  ...
  public class DlgRptKIBAControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "KIBA.rpt";
      CS[ReportUtils.PDFNAME] = "KIBA.pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.KIBA.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "KIB A", RptClass = LinkPdf };
