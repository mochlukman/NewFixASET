...
namespace Usadi.Valid49.BO
{
  ...
  public class DlgRptKIBBControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "KIBB.rpt";
      CS[ReportUtils.PDFNAME] = "KIBB.pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.KIBB.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "KIB B", RptClass = LinkPdf };
