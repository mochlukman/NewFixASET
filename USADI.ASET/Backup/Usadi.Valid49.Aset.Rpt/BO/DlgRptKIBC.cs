...
namespace Usadi.Valid49.BO
{
  ...
  public class DlgRptKIBCControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "KIBC.rpt";
      CS[ReportUtils.PDFNAME] = "KIBC.pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.KIBC.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "KIB C", RptClass = LinkPdf };
