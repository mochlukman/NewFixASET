...
namespace Usadi.Valid49.BO
{
  ...
  public class DlgRptKIBDControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "KIBD.rpt";
      CS[ReportUtils.PDFNAME] = "KIBD.pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.KIBD.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "KIB D", RptClass = LinkPdf };
