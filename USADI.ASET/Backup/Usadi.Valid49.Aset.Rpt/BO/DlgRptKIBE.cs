...
namespace Usadi.Valid49.BO
{
  ...
  public class DlgRptKIBEControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "KIBE.rpt";
      CS[ReportUtils.PDFNAME] = "KIBE.pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.KIBE.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "KIB E", RptClass = LinkPdf };
