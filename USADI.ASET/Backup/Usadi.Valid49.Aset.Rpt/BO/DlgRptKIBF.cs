...
namespace Usadi.Valid49.BO
{
  ...
  public class DlgRptKIBFControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "KIBF.rpt";
      CS[ReportUtils.PDFNAME] = "KIBF.pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.KIBF.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "KIB F", RptClass = LinkPdf };
