...
{
  #region Usadi.Valid49.BO.DlgRptMutasiBrgControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptMutasiBrgControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "MutasiBrg.rpt";
      CS[ReportUtils.PDFNAME] = "MutasiBrg.pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.MutasiBrg.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "Laporan Mutasi Barang", RptClass = LinkPdf };
