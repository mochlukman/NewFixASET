...
{
  #region Usadi.Valid49.BO.DlgRptRekapMutasiBrgControl, Usadi.Valid49.Aset.Rpt
  [Serializable]
  public class DlgRptRekapMutasiBrgControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public DlgRptRekapMutasiBrgControl()
    {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "RekapMutasiBrg.rpt";
      CS[ReportUtils.PDFNAME] = "RekapMutasiBrg.pdf";
      ...
      string pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.RekapMutasiBrg.rpt", CS, Params);
      return pdfurl;
    }
    ...
    {
      RptPars rptPar = new RptPars() { Title = "Rekap Mutasi Barang", RptClass = LinkPdf };
  ...
  #endregion DlgRptRekapMutasiBrg
}
