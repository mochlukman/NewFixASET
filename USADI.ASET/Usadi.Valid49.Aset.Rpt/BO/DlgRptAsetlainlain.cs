...
namespace Usadi.Valid49.BO
{
  ...
  public class DlgRptAsetlainlainControl : DaftunitControl, IDataControlUIEntry, IPrintable
  {
    ...
    public string GetURLReport(int n)
    {
      ...
      CS[ReportUtils.RPTNAME] = "ASETLAINLAIN.rpt";
      ...
      if(n == 0)
      {
        pdfurl = ReportUtils.ExportPDF("Usadi.Valid49.Aset.Rpt.Rpt.ASETLAINLAIN.rpt", CS, Params);
      }
      else
      {
        CS[ReportUtils.PDFNAME] = "ASETLAINLAIN_" + (string)GlobalAsp.GetSessionUser().GetValue("Userid") + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        pdfurl = ReportUtils.ExportExcel("Usadi.Valid49.Aset.Rpt.Rpt.ASETLAINLAIN.rpt", CS, Params);
      } 
      return pdfurl;
    }
