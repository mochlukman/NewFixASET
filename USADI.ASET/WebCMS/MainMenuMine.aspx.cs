...
public partial class MainMenu : System.Web.UI.Page
{
    ...
    try
    {
      if (GlobalAsp.CekSessionMenu(Page))
      {
        ...
        if (!X.IsAjaxRequest)
        {
          ...
          {
            //Set AppID inside
            dcMenu.SetOtorisasiMenu(GlobalAsp.GetSessionUser().GetUserID(), GlobalAsp.GetRequestApp());
  ...
  public string SettingGroup()
  {
    ...
    try
    {
      ...
      //{
      //  //Set AppID inside
      //  cMenu.SetOtorisasiMenu(GlobalAsp.GetSessionUser().GetUserID(), GlobalAsp.GetRequestApp());
      //  idapp = cMenu.GetValue(textFilterIdapp.DataIndex).ToString();
      //}
      //textFilterIdapp.Text = idapp;
      ...
      cMenu.SetOtorisasiMenu(GlobalAsp.GetSessionUser().GetUserID(), textFilterIdapp.Text);
      ...
      if (!string.IsNullOrEmpty(url))
      {
        ...
        //Pages.RemoveAll();
        //Pages.Add(tabHome);
        //foreach (Ext.Net.Panel p in Pages.Items)
        //{
        //  if (p != tabHome)
        //  {
        //    Pages.Remove(p.ID, true);
        //  }
        //}
  ...
  public void CreateToolbar()
  {
    ...
    btnPassword.Listeners.Click.Handler = string.Format("e.stopEvent(); loadPage(#{0}, '{1}','{1}','System/SetPassword.aspx');", "{Pages}", change_passwd);
    btnPassword.Hidden = StatusBar1.Hidden;
    ...
    //btnProfile.Hidden = StatusBar1.Hidden;
