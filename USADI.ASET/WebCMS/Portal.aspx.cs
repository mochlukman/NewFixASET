...
public partial class Portal : System.Web.UI.Page
{
  ...
  private Ext.Net.MenuItem CreateMenuWithChildren(List<SsappControl> list, SsappControl parent)
  {
    ...
    string prefix = System.Configuration.ConfigurationManager.AppSettings["URLPrefix"];
    ...
    {
      menuNode.Listeners.Click.Handler = string.Format("CoreNET.LoadPage('{0}');", parent.UrlFull);
    }
    if (MasterAppConstants.Instance.StatusTesting)
    {
      if (parent.Status == -1)
